...
CREATE TABLE `{!!prefix!!}srvc_service_prices` (
  ...
  `notes` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'Informational service price configuration and properties' CHECK (json_valid(`metadata`)),
  ...
  `created_by` bigint(20) unsigned NOT NULL COMMENT 'to user table',
  `updated_by` bigint(20) unsigned NOT NULL COMMENT 'to user table',
  PRIMARY KEY (`id`),
